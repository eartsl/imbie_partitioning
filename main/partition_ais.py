...
smb_uncert_amory_zwally = amory['Relative Mass Change Uncertainty (Gt)'].iloc[
    amory_idx_zwally].values
...
########################################
niwano = pd.read_csv('/Users/thomas/Documents/github/imbie_partitioning/aux/smb_datasets/Niwano_surface-mass-balance_62578ab94d14f6.50682970/mass-balance-data/NHM-SMAP_v1.0_1979-2021_rate-of-mass-change_IMBIE3_AIS.csv',
                     float_precision = 'round_trip')
...
########################################
wever = pd.read_csv('/Users/thomas/Documents/github/imbie_partitioning/aux/smb_datasets/Wever_surface-mass-balance_6268d0772b5c72.42340985/mass-balance-data/imbie.csv',
...
plt.savefig('/Users/thomas/Documents/github/imbie_partitioning/figs/smb_datasets_ais.svg',
...
plt.savefig('/Users/thomas/Documents/github/imbie_partitioning/figs/smb_combined_ais.svg',
            format='svg', dpi=600, bbox_inches='tight')
fig.clf()
plt.close(fig)
...
# load IMBIE data
imbie = pd.read_csv(
    '/Users/thomas/Documents/github/imbie_partitioning/aux/imbie_datasets/imbie_antarctica_2021_Gt.csv')
...
plt.savefig('/Users/thomas/Documents/github/imbie_partitioning/figs/imbie_partitioned_ais.svg',
            format='svg', dpi=600, bbox_inches='tight')
fig.clf()
plt.close(fig)
